        ...
        <div className='R2'>
          <div className='R3'>
            ...
            <div className='R6-icon'>
              ...
              <a href="https://www.facebook.com" target='_blank' rel="noopener noreferrer"><img src='/image/icons8-facebook-48.png' alt='img' /></a>
              <a href="https://www.linkedin.com" target='_blank' rel="noopener noreferrer"><img src='/image/icons8-linkedin-48.png' alt='img' /></a>
              <a href="https://www.whatsapp.com" target='_blank' rel="noopener noreferrer"><img src='/image/icons8-whatsapp-48.png' alt='img' /></a>
              <a href="https://www.instagram.com" target='_blank' rel="noopener noreferrer"><img src='/image/icons8-instagram-48.png' alt='img' /></a>
              <a href="https://www.twitter.com" target='_blank' rel="noopener noreferrer"><img src='/image/icons8-twitter-circled-48.png' alt='img' /></a>
            </div>
          ...
          <div className='R12'> <span  className='ang'> <span>Next Post</span> </span></div>
          <div className='R13'>
            <div className='R14'>
